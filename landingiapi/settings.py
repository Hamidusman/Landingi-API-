"""
Django settings for landingiapi project.
...
SECRET_KEY = 'django-insecure-zq03u7sc=xv$)or#%up-94wi4&*9ln7^+=+!u$%lg0#gb2e4c+'
...
WSGI_APPLICATION = 'landingiapi.wsgi.application'
